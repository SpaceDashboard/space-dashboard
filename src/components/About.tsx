    ...
    <Modal isOpen={isAboutOpen} setIsOpen={setIsAboutOpen}>
      <>
        ...
        <p>
          ...
          site because I, like yourself, wanted as much space related data on my
          screen as possible. If you like this, great! I'm happy I can make an
          impact.
        </p>
        ...
        <p>
          <a href="mailto:caleb@spacedashboard.com">caleb@spacedashboard.com</a>
        </p>
