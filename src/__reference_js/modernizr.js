...
*/
  ...
  Modernizr.addTest(
    'aping',
    !window.externalHost && 'ping' in createElement('a'),
  );
...
*/
  ...
  Modernizr.addTest(
    'areaping',
    !window.externalHost && 'ping' in createElement('area'),
  );
...
*/
  ...
  Modernizr.addAsyncTest(function () {
    ...
    function testpreload(event) {
      clearTimeout(timeout);
      var result =
        event !== undefined && event.type === 'loadeddata' ? true : false; //need to check if event is not undefined here in case function is evoked from timeout (no parameters)
...
*/
  ...
  Modernizr.addTest('canvastext', function () {
    ...
    return (
      typeof createElement('canvas').getContext('2d').fillText === 'function'
    );
  });
...
!*/
  ...
  Modernizr.addTest(
    'cssgridlegacy',
    testAllProps('grid-columns', '10px', true),
  );
  Modernizr.addTest(
    'cssgrid',
    testAllProps('grid-template-rows', 'none', true),
  );
    ...
    function runHyphenTest() {
      ...
      function test_hyphens_css() {
        try {
          ...
          /* results */
          result =
            span.offsetHeight !== spanHeight || span.offsetWidth !== spanWidth;
...
*/
  ...
  testStyles(
    ...
    function (elem) {
      ...
      var correctWidths =
        elems[0].offsetWidth === elems[2].offsetWidth &&
...
!*/
  ...
  testStyles(
    ...
    function (node) {
      Modernizr.addTest(
        'cssscrollbar',
        'scrollWidth' in node && node.scrollWidth === 30,
      );
    },
  );
...
!*/
  ...
  Modernizr.addTest(
    ...
    function () {
      try {
        return (
          createElement('<input name="test" />').getAttribute('name') === 'test'
        );
      } catch (e) {
        return false;
      }
...
*/
  ...
  Modernizr.addTest(
    'shadowrootlegacy',
    'createShadowRoot' in createElement('div'),
  );
...
!*/
  ...
  Modernizr.addTest('ruby', function () {
    ...
    if (
      computedStyle(rp, null, 'display') === 'none' || // for non-IE browsers
      // but in IE browsers <rp> has "display:inline" so, the test needs other conditions:
      (computedStyle(ruby, null, 'display') === 'ruby' &&
        computedStyle(rt, null, 'display') === 'ruby-text') || // for IE8+
      (computedStyle(rp, null, 'fontSize') === '6pt' &&
        computedStyle(rt, null, 'fontSize') === '6pt')
    ) {
      // for IE6 & IE7
...
*/
  ...
  Modernizr.addTest('localizednumber', function () {
    ...
    div.innerHTML =
      '<input type="number" value="1.0" step="0.1" style="position: fixed; top: 0;" />';
...
*/
  ...
  Modernizr.addTest(
    'fullscreen',
    !!(
      prefixed('exitFullscreen', document, false) ||
      prefixed('cancelFullScreen', document, false)
    ),
  );
  ...
  Modernizr.addTest('unicoderange', function () {
    return testStyles(
      ...
      function (elem) {
        ...
        return (
          testGlyphs[0] !== testGlyphs[1] && testGlyphs[2] === testGlyphs[3]
        );
      },
    );
  });
  ...
  (function () {
    ...
    try {
      if (!!elem.canPlayType) {
        Modernizr.addTest(
          'video.ogg',
          elem.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, ''),
        );
        ...
        Modernizr.addTest(
          'video.h265',
          elem.canPlayType('video/mp4; codecs="hev1"').replace(/^no$/, ''),
        );
        Modernizr.addTest(
          'video.webm',
          elem
        ...
        Modernizr.addTest(
          'video.vp9',
          elem.canPlayType('video/webm; codecs="vp9"').replace(/^no$/, ''),
        );
        Modernizr.addTest(
          'video.hls',
          elem
        ...
        Modernizr.addTest(
          'video.av1',
          elem.canPlayType('video/mp4; codecs="av01"').replace(/^no$/, ''),
        );
      }
    } catch (e) {}
  })();
  ...
  Modernizr.addTest('datachannel', function () {
    ...
    for (var i = 0, len = domPrefixesAll.length; i < len; i++) {
      var PeerConnectionConstructor =
        window[domPrefixesAll[i] + 'RTCPeerConnection'];
